function activity = isolate_behavior_arch1(timeseries, session_raw, behavior, varargin)
% Pull out sections of timeseries, for each region, that correspond to the
% specified behavior of interest. 
%
% Archived on 1/3/23 after adding Investigate_M vs. Investigate_F options.
% 
% PARAMETERS
% ----------
